...
BACKTEST_DAYS = 60
CACHE_DIR = os.path.join(PROJECT_ROOT, "okx_data", "backtest_cache")
...
def backtest_symbol(sym, data_1h, data_4h, data_1d):
    ...
    while current <= end:
        ...
        dmi_1h, adx_1h, _ = trend_dmi(new_1h)
        dmi_4h, adx_4h, _ = trend_dmi(new_4h)
        dmi_1d, adx_1d, _ = trend_dmi(new_1d)
