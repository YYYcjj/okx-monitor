...
NEAR_LEVEL_PCT = 0.015    # (已停用为门槛，2026-09-07 用户去掉「贴日线关键位未破」条件；保留仅供参考)
...
ATR_PERIOD = 14
ATR_MIN_RATIO = 0.005   # (已停用为门槛，2026-09-07 起只要求 < ATR_MAX_RATIO；保留仅供参考)
ATR_MAX_RATIO = 0.02    # ATR/价格 < 2%，波动过大(风险失控)则剔除（唯一波动门槛，2026-09-07 起）
# 目标空间硬门（MIN_SPACE_PCT/MIN_SPACE_ATR/space_ok）已于 2026-09-07 移除：盈亏比门槛导致零推送，
# 空间(目标位)恢复为仅展示、不参与过滤。
